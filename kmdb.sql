...
SELECT movies.title, movies.year_dropped, movies.mpaa_rating, studios.name
FROM movies
INNER JOIN studios ON studios.id = movies.studio
;
...
INNER JOIN actors ON actors.id = roles.roles_id;
